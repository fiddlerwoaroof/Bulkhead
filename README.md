A new frontend for viewing information about Docker running on your Mac. It should support Colima and Rancher Desktop out of the box, but you can specify your own docker port in the settings.
